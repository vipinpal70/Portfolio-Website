...
interface WebGLExtensionFormats {
...
interface WebGLExtensions {
  ...
  formatRGBA: WebGLExtensionFormats;
  formatRG: WebGLExtensionFormats;
  formatR: WebGLExtensionFormats;
...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let formatRGBA: WebGLExtensionFormats = {
        internalFormat: gl.RGBA,
        format: gl.RGBA
      };
      
      let formatRG: WebGLExtensionFormats = {
        internalFormat: gl.RGBA,
        format: gl.RGBA
      };
      
      let formatR: WebGLExtensionFormats = {
        internalFormat: gl.RGBA,
        format: gl.RGBA
      };
      ...
      if (isWebGL2) {
        ...
        formatRGBA = getSupportedFormat(gl, gl2.RGBA16F, gl2.RGBA, halfFloatTexType) || formatRGBA;
        formatRG = getSupportedFormat(gl, gl2.RG16F, gl2.RG, halfFloatTexType) || formatRG;
        formatR = getSupportedFormat(gl, gl2.R16F, gl2.RED, halfFloatTexType) || formatR;
      } else {
        formatRGBA = getSupportedFormat(gl, gl.RGBA, gl.RGBA, halfFloatTexType) || formatRGBA;
        formatRG = formatRGBA; // Fallback to RGBA for WebGL1
        formatR = formatRGBA;  // Fallback to RGBA for WebGL1
      }
