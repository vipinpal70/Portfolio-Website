...
const projects: Project[] = [
  {
    ...
    description:
      "Full-stack automated trading system for crypto and Indian stock markets, with real-time data processing and alert systems.",
    imageSrc:
      "https://images.unsplash.com/photo-1518183214770-9cffbec72538?q=80&w=800&auto=format&fit=crop",
    tags: ["Python", "AWS", "Pandas", "Telegram API"],
    demoLink: "https://app.astutealgo.com/",
  ...
  },
  {
    ...
    description:
      "Machine learning model to predict home prices in Bangalore based on 14 features, achieving 89% prediction accuracy.",
    imageSrc:
  ...
  },
  {
    ...
    description:
      "Python desktop application to automate file organization with a user-friendly GUI and configurable settings.",
    imageSrc:
      "https://images.unsplash.com/photo-1593720213428-28a5b9e94613?q=80&w=800&auto=format&fit=crop",
    tags: ["Python", "PyQt6", "Nuitka", "Inno Setup"],
    demoLink:
      "https://github.com/vipinpal70/File_Organizer/releases/download/v1.0.0/FileOrganizerSetup.exe",
    githubLink: "https://github.com/vipinpal70",
    downloadLink:
      "https://github.com/vipinpal70/File_Organizer/releases/download/v1.0.0/FileOrganizerSetup.exe",
  },
  {
    ...
    description:
      "Web application for real-time video communication using Socket.IO and WebRTC for peer-to-peer video streaming. Features include screen sharing, chat functionality, and room creation.",
    imageSrc:
      "https://images.unsplash.com/photo-1587614313085-5da51cebd8ac?q=80&w=800&auto=format&fit=crop",
    tags: ["JavaScript", "WebRTC", "Socket.IO", "Express.js"],
    demoLink: "https://morning-escarpment-67980.onrender.com/",
    githubLink: "https://github.com/vipinpal70",
  },
  {
    id: 5,
    ...
    description:
      "Fitness application that integrates with Rapid-API for accessing workout data, tracking fitness goals, and generating personalized plans.",
    imageSrc:
      "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800&auto=format&fit=crop",
    tags: ["React", "RapidAPI", "CSS3", "Vercel"],
    demoLink: "https://fitness-app-liart.vercel.app/",
    githubLink: "https://github.com/vipinpal70",
  },
  {
    id: 6,
    ...
    description:
      "Predictive model for automating credit card application approvals based on user details and financial history.",
    imageSrc:
