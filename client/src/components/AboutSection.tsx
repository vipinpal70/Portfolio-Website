...
const AboutSection = () => {
  return (
    <section id="about" className="py-16 md:py-24 bg-dark-100 dark:bg-dark-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold font-sans text-dark-900 dark:text-white mb-4">About Me</h2>
          <p className="text-lg text-dark-600 dark:text-dark-400 max-w-3xl mx-auto">
            I'm a Python and Full-Stack Developer passionate about building scalable solutions and automating financial systems.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              <div className="timeline-item pb-8">
                <h4 className="text-lg font-semibold text-dark-900 dark:text-white">Master of Computer Application (MCA)</h4>
                <p className="text-primary-600 dark:text-primary-400 mb-1">Vellore Institute of Technology, Bhopal</p>
                <p className="text-dark-600 dark:text-dark-400">2022 - 2024</p>
              </div>
              <div className="timeline-item">
                <h4 className="text-lg font-semibold text-dark-900 dark:text-white">Bachelor of Computer Application (BCA)</h4>
                <p className="text-primary-600 dark:text-primary-400 mb-1">DAV P.G College, CCSU University, Meerut</p>
