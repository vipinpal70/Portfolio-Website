...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-white dark:bg-dark-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold font-sans text-dark-900 dark:text-white mb-4">Get In Touch</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-dark-300 dark:border-dark-700 bg-white dark:bg-dark-900 text-dark-900 dark:text-white form-input focus:outline-none focus:ring-2 focus:ring-primary-500 transition" 
                    required 
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 rounded-lg border border-dark-300 dark:border-dark-700 bg-white dark:bg-dark-900 text-dark-900 dark:text-white form-input focus:outline-none focus:ring-2 focus:ring-primary-500 transition resize-none" 
                  required
                ></textarea>
              </div>
          ...
          >
            <div className="mb-8">
              <h3 className="text-2xl font-semibold text-dark-900 dark:text-white mb-4">Let's Build Something Amazing!</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-dark-600 dark:text-dark-400">+91 706-029-8070</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              <h4 className="text-lg font-medium text-dark-900 dark:text-white mb-4">Follow Me</h4>
