...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-white dark:bg-gray-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold font-sans text-gray-900 dark:text-white mb-4">Get In Touch</h2>
