...
export default function RealityCheckSectionTwo() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 py-20"
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full border-l border-blue-500/10 rotate-45 animate-pulse-slow" />
        <div
          className="absolute -bottom-1/2 -right-1/2 w-full h-full border-l border-pink-500/10 -rotate-45 animate-pulse-slow"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 animate-expand" />
            </span>
          </h2>
        </div>
        ...
        <div className="space-y-6 mb-16">
          {painPoints.map((point, index) => (
            <div
              key={index}
              className={`group relative p-6 sm:p-8 rounded-2xl bg-slate-900/50 backdrop-blur-sm border border-slate-800 hover:border-purple-500/50 transition-all duration-500 hover:scale-[1.02] hover:bg-slate-900/80 ${
                isVisible ? "animate-slide-in-left" : "opacity-0"
              }`}
              style={{ animationDelay: `${index * 150}ms` }}
            >
              {/* Purple/Pink Glow on Hover */}
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600/0 via-purple-600/10 to-pink-600/0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

              <div className="relative z-10 flex items-start space-x-4">
                {/* Animated Blue/Purple Circle */}
                <div className="flex-shrink-0 mt-1">
                  <div className="relative w-4 h-4">
                    ...
                    <div className="relative w-4 h-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full" />
                  </div>
                </div>

                <div className="flex-1">
                  <p className="text-xl sm:text-2xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors">
                    {point.text}
                  </p>
        ...
        >
          ...
          <div className="w-32 h-1 bg-gradient-to-r from-transparent via-purple-500 to-transparent mx-auto animate-pulse" />
        </div>
        ...
        >
          <div className="absolute -inset-4 bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-pink-600/20 rounded-3xl blur-2xl animate-pulse-slow" />

          <div className="relative p-8 sm:p-10 rounded-3xl bg-slate-900/80 backdrop-blur-sm border border-slate-700">
