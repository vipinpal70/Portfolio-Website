...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getUniforms(program: WebGLProgram) {
      const uniforms: Record<string, WebGLUniformLocation | WebGLTexture | number | number[] | Float32Array | null> = {};
  ...
  return (
    <div className="fixed top-0 left-0 z-50 pointer-events-none w-full h-full opacity-35">
      <canvas
        ref={canvasRef}
        id="fluid"
