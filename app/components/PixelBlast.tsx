    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        uniforms.uTime.value =
          ...
          if (liquidEffect) {
            const uniforms = (liquidEffect as unknown as { uniforms: Map<string, THREE.Uniform> }).uniforms;
            const timeUniform = uniforms.get("uTime");
            if (timeUniform) {
              timeUniform.value = uniforms.get("uTime")?.value || 0; // Use get() instead of dot notation
            }
          }
        if (composer) {
